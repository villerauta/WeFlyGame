...
public class InteractableEditor : EditorWithSubEditors<ConditionCollectionEditor, ConditionCollection>
{
    ...
    private const string interactablePropInteractableTextName = "interactionText";
    ...
    private void OnEnable ()
    {
        ...
        interactionTextProperty = serializedObject.FindProperty(interactablePropInteractableTextName);
